...
import config
from data_process.process_PredictData import PredictData
from tool import getFutureVehicle
...
class TrajectoryState(object):
    ...
    def __init__(self, train=True):
        ...
        # [len(self.index) // 4: len(self.index) * 3 // 4]
    ...
    def __getitem__(self, item):
        ...
        return self.input[self.index[item]]['grid'], \
               ...
               # self.input[self.index[item]]['vid-now'], \
               # self.input[self.index[item]]['vid-before'], self.input[self.index[item]]['rid'], \
               # self.input[self.index[item]]['t'], \
